      ...
      <div className="d-flex flex-column bg-light min-vh-100">
        <nav className="navbar navbar-expand-lg navbar-dark bg-secondary shadow-sm">
          <div className="container">
            <Link className="navbar-brand text-white" to="/dashboard">Student Feedback App</Link>
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <Link className="nav-link nav-link-custom text-white" to="/dashboard">Dashboard</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link nav-link-custom text-white" to="/rate">Rate Course</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link nav-link-custom text-white" to="/view">View Feedback</Link>
                </li>
              </ul>
            </div>
          </div>
